...
async function runServerlessDeploy() {
  try {
    ...
    // Serverless access key
      ...
      await exeq(`export SERVERLESS_ACCESS_KEY=${inputs.SERVERLESS_ACCESS_KEY} && serverless deploy --verbose || echo "::error:: Serverless deploy failed"`, { cwd: WORKING_DIRECTORY })
    }
